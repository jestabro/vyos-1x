...
def dict_from_tree(ct, path=[], key_mangling=None, get_first_key=False,
                   no_multi_convert=False, no_tag_node_value_mangle=False):
    """ Get python dict from arbitrary configtree at path

        This is a direct translation of the construction in
        config.get_config_dict to arbitrary config trees;
